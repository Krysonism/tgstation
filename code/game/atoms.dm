...
/atom/movable/proc/point_at(atom/A)
	...
	animate(visual, pixel_x = (tile.x - our_tile.x) * WORLD_ICON_SIZE_WIDTH + A.pixel_x, pixel_y = (tile.y - our_tile.y) * WORLD_ICON_SIZE_VIRTUAL_HEIGHT + A.pixel_y, time = 1.7, easing = EASE_OUT)
