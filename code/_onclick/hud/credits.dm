...
#define CREDIT_ANIMATE_HEIGHT (14 * WORLD_ICON_SIZE_VIRTUAL_HEIGHT)
...
/atom/movable/screen/credit/Initialize(mapload, credited, client/P, icon/I)
	...
	maptext_x = WORLD_ICON_SIZE_WIDTH + 8
	maptext_y = (WORLD_ICON_SIZE_VIRTUAL_HEIGHT / 2) - 4
	maptext_width = WORLD_ICON_SIZE_WIDTH * 3
